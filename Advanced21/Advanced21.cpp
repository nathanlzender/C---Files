// Advanced21.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void standardMembership(double rewardsPoints, double monthlyPurchaseAmount)
{
...
void plusMembership(double rewardsPoints, double monthlyPurchaseAmount)
{
    //multiple if statements to check for monthly purchased amount and calculate rewards points
...
void premiumMembership(double rewardsPoints, double monthlyPurchaseAmount)
{
